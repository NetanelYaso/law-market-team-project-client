        ...
        <Row>
          ...
          <Col md={6} className=" ">
            <div className="description">
              <div className="    ">
                <div className="p-5 text-primary align-content-center">
                  אנו חבורת אנשים שהתאגדה יחד כאשר הגורם המאחד והחזק שלה הוא
                  הנגשת שירות מקצועי אמין ברמת שירות גבוהה לכול דורש החל מעסקים
                  קטנים וגדולים כאחד דרך משפחות ושותפים ועד לאדם הפרטי.<br></br>
          ...
          <Col md={6} className=" p-text d-flex p-5">
            <div className="description    ">
              <div className="d-flex  justify-content-center align-content-center  ss">
                <div className="p-text text-primary al">
